            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex flex-wrap gap-6'>
                        ...
                        <div className='felx flex-col items-center'>
                            <div className='flex items-center gap-2'>
                                <input type='number' id='regullarPrice' min='1' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                                <p>Regular Price</p>
                ...
                <buttom className='p-3 bg-slate-700 text-center text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-85'>
                    Create Listing
                </buttom>
                </div>
            </form>
